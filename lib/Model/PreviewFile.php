 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PreviewFile implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PreviewFile';
    ...
    /**
     * Sets image
     * @param string $image Binary image content, base64 encoded.
     * @return $this
     */
