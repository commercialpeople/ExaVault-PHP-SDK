...
/**
 * ShareLogEntry Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ShareLogEntry implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShareLogEntry';
    ...
    /**
     * Sets share_id
     * @param string $share_id ID of the share this log entry belongs to.
     * @return $this
     */
    ...
    /**
     * Sets username
     * @param string $username Username of the user triggered the action.
     * @return $this
     */
    ...
    /**
     * Sets action
     * @param string $action Type of the action that happened in the share.
     * @return $this
     */
     ...
     * @param string $action_object_id ID of the object that the action happened to.
     * @return $this
     */
    ...
    /**
     * Sets detail
     * @param string $detail Recipients the share was sent to.
     * @return $this
     */
