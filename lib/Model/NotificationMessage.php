...
/**
 * NotificationMessage Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class NotificationMessage implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotificationMessage';
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'notification_setting' => '\Swagger\Client\Model\Notification',
        'message' => 'string',
        'path' => 'string',
        'action' => 'string',
        'username' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['notification_setting'] = isset($data['notification_setting']) ? $data['notification_setting'] : null;
    ...
    /**
     * Sets id
     * @param int $id ID of the notifications message.
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\Notification $notification_setting Notification which triggered this message.
     * @return $this
     */
    ...
    /**
     * Sets path
     * @param string $path Path to the resource the notification is set on.
     * @return $this
     */
    ...
    /**
     * Sets action
     * @param string $action Action which triggers the notification.
     * @return $this
     */
    ...
    /**
     * Sets username
     * @param string $username Name of the user that triggered the notification.
     * @return $this
     */
    ...
    /**
     * Sets sent
     * @param bool $sent Flag set to true if a notification email was sent.
     * @return $this
     */
    ...
    /**
     * Sets created
     * @param string $created Timestamp of notification message creation.
     * @return $this
     */
