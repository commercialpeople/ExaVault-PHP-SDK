 ...
 *
 * @category    Class
 * @description Object with authentication info.
 * @package     Swagger\Client
...
class Auth implements ArrayAccess
{
    ...
    /**
     * Sets username
     * @param string $username Name of the authenticated user.
     * @return $this
     */
    ...
    /**
     * Sets access_token
     * @param string $access_token Token to use for API calls.
     * @return $this
     */
    ...
    /**
     * Sets mode
     * @param int $mode Authentication mode.
     * @return $this
     */
    ...
    /**
     * Sets client_ip
     * @param string $client_ip IP address of the authenticated client.
     * @return $this
     */
