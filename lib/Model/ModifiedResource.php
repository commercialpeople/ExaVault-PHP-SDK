...
/**
 * ModifiedResource Class Doc Comment
 *
 * @category    Class
 * @description Array of copied or moved resources.
 * @package     ExaVault\Sdk
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModifiedResource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifiedResource';
    ...
    /**
     * Sets file
     * @param string $file Path to the resource.
     * @return $this
     */
    ...
    /**
     * Sets destination
     * @param string $destination Destinsation path of the operation.
     * @return $this
     */
    ...
    /**
     * Sets success
     * @param int $success Flag indicates operation success status. `0` is failure; `1` is success.
     * @return $this
     */
