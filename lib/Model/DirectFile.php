 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DirectFile implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DirectFile';
    ...
    protected static $swaggerFormats = [
        ...
        'path' => null,
        'is_enabled' => null,
        'is_index_enabled' => null,
        'block_until' => 'YYYY-mm-dd hh:mm:ss',
        'created' => null,
        'modified' => null
    ];
    ...
    protected static $setters = [
        ...
        'is_index_enabled' => 'setIsIndexEnabled',
        'block_until' => 'setBlockUntil',
        'created' => 'setCreated',
    ...
    protected static $getters = [
        ...
        'is_index_enabled' => 'getIsIndexEnabled',
        'block_until' => 'getBlockUntil',
        'created' => 'getCreated',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_index_enabled'] = isset($data['is_index_enabled']) ? $data['is_index_enabled'] : null;
        $this->container['block_until'] = isset($data['block_until']) ? $data['block_until'] : null;
    ...
    /**
     * Sets id
     * @param int $id ID of the direc file object.
     * @return $this
     */
    ...
    /**
     * Sets account_id
     * @param string $account_id ID of the account this direct file object belongs to.
     * @return $this
     */
    ...
    /**
     * Sets path
     * @param string $path Path to the folder direct file is set on.
     * @return $this
     */
    ...
    /**
     * Sets is_enabled
     * @param string $is_enabled Flag indicates if direct file is turned `on` or `off`.
     * @return $this
     */
    ...
    /**
     * Gets is_index_enabled
     * @return string
     */
    public function getIsIndexEnabled()
    {
        return $this->container['is_index_enabled'];
    }

    /**
     * Sets is_index_enabled
     * @param string $is_index_enabled Flag indicates if folder listing is `on` or `off`. If it is enabled you can see folder content in the browser.
     * @return $this
     */
    public function setIsIndexEnabled($is_index_enabled)
    {
        $this->container['is_index_enabled'] = $is_index_enabled;
    ...
    {
        return $this->container['block_until'];
    }

    /**
     * Sets block_until
     * @param string $block_until Timestamp of direct file block until date. Equals `0000-00-00 00:00:00` when no block date is setup. Used when direct file bandwidth quota limit crossed.
     * @return $this
     */
    public function setBlockUntil($block_until)
    {
        $this->container['block_until'] = $block_until;
    ...
    /**
     * Sets created
     * @param string $created Unix timestamp of direct file creation.
     * @return $this
     */
    ...
    /**
     * Sets modified
     * @param string $modified Unix timestamp of direct file modification.
     * @return $this
     */
