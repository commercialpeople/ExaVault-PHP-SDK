 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModifiedResourcesResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifiedResourcesResponse';
    ...
    /**
     * Sets success
     * @param int $success Flag indicates API call status. `0` is failure; `1` is success; `2` means partial success - some but not all files were moved, copied or deleted.
     * @return $this
     */
