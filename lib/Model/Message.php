...
class Message implements ArrayAccess
{
    ...
    /**
     * Sets user_id
     * @param int $user_id ID of the user this message belogns to.
     * @return $this
     */
    ...
    /**
     * Sets share_id
     * @param string $share_id ID of the share this message belongs to.
     * @return $this
     */
    ...
    /**
     * Sets created
     * @param string $created Timestamp of message creation.
     * @return $this
     */
    ...
    /**
     * Sets modified
     * @param string $modified Timestamp of message modification.
     * @return $this
     */
