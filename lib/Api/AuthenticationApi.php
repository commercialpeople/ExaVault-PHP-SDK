...
class AuthenticationApi
{
    ...
    {
        list($response) = $this->authenticateUserWithHttpInfo($api_key, $username, $password);
        return $response;
    }
    ...
    public function authenticateUserWithHttpInfo($api_key, $username, $password)
    {
        ...
        if ($api_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_key when calling authenticateUser');
        }
        // verify the required parameter 'username' is set
        if ($username === null) {
            throw new \InvalidArgumentException('Missing the required parameter $username when calling authenticateUser');
        }
        // verify the required parameter 'password' is set
        if ($password === null) {
            throw new \InvalidArgumentException('Missing the required parameter $password when calling authenticateUser');
        }
        // parse inputs
    ...
    {
        list($response) = $this->logoutUserWithHttpInfo($api_key, $access_token);
        return $response;
    }
    ...
    public function logoutUserWithHttpInfo($api_key, $access_token)
    {
        // verify the required parameter 'api_key' is set
        if ($api_key === null) {
            throw new \InvalidArgumentException('Missing the required parameter $api_key when calling logoutUser');
        }
        // verify the required parameter 'access_token' is set
        if ($access_token === null) {
            throw new \InvalidArgumentException('Missing the required parameter $access_token when calling logoutUser');
        }
        // parse inputs
        $resourcePath = "/logoutUser";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
